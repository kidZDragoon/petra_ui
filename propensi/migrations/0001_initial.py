    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filePDF', models.FileField(max_length=500, null=True, upload_to=propensi.models.KaryaIlmiah.get_upload_path,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(
                    blank=True, max_length=128, verbose_name='nama')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                                    related_name='semester_disetujui', to='propensi.semester'),
        ),
        migrations.AddField(
            model_name='karyailmiah',
            name='userPengunggah',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                                    related_name='user_pengunggah', to='propensi.profile'),
        ),
        migrations.AddField(
            model_name='karyailmiah',
            name='verifikator',
